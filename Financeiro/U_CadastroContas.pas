...
begin
  ...
  if (edtDescricaoReceber.EditText.IsEmpty and pnlContasReceber.Visible) then
  begin
    ShowMessage('É Necessário adicionar uma descrição para a conta !');
    Abort
  end;
  ...
  if (edtVencimentoReceber.EditText.IsEmpty and pnlContasReceber.Visible) then
  begin
    ShowMessage('É Necessário adicionar uma data de vencimento para a conta !');
    Abort
  end;
  ...
  if (edtValorReceber.EditText.IsEmpty and pnlContasReceber.Visible) then
  begin
    ShowMessage('É Necessário adicionar um valor para a conta !');
    Abort
  end;
